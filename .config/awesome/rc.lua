...
beautiful.init("/home/skraikov/.config/awesome/themes/default/theme.lua")
...
-- Use Win key for VMs, custom Mod5 for real hosts
...
globalkeys = gears.table.join(
    ...
    -- User programs
    awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn(terminal .. " -e mc") end,
              {description = "open a terminal with mc", group = "launcher"}),
    -- sound volume control
    awful.key({                   }, "XF86AudioRaiseVolume",
       function () awful.spawn("amixer -q set Master 2dB+ unmute") end,
    ...
    -- yandex radio control
    awful.key({                   }, "XF86AudioPlay",
       function () awful.spawn("/home/skraikov/.local/bin/radio.yandex.ru-client playpause") end,
       {description = "play/pause yandex radio", group = "sound"}),
